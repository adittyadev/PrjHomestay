...
@section('content_header')
    <h1>
        <i class="fas fa-sign-out-alt"></i> Daftar Checkout Tamu
    </h1>
@stop
...
<div class="card">
    <div class="card-header bg-danger">
        <h3 class="card-title">
            <i class="fas fa-list"></i> Daftar Tamu Siap Checkout
        </h3>
    </div>
    <div class="card-body">
        <table id="checkoutTable" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge badge-primary badge-lg">#{{ $b->id }}</span>
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                        <form action="{{ route('admin.checkout.proses', $b->id) }}" 
                              method="POST" 
                              class="checkout-form">
                            @csrf
                            <button type="button" 
                                    class="btn btn-danger btn-sm btn-checkout"
                ...
                @if (count($bookings) == 0)
                    <tr>
                        <td colspan="8" class="text-center py-4">
                            ...
                            <strong class="text-muted">Tidak ada tamu yang siap checkout</strong>
                        </td>
                    </tr>
                @endif
            </tbody>
                    ...
                    <div class="modern-confirm-overlay" id="confirmModal">
                        <div class="modern-confirm-box">
                            <div class="modern-confirm-header">
                                ...
                                <h3 class="modern-confirm-title">Konfirmasi Checkout</h3>
                            </div>
                            <div class="modern-confirm-body">
                                <p class="modern-confirm-message">
                                    Apakah Anda yakin ingin melakukan checkout untuk tamu ini?
                                </p>
                            ...
                            <div class="modern-confirm-footer">
                                ...
                                <button type="button" class="modern-confirm-btn modern-confirm-btn-confirm" onclick="confirmCheckout()">
                                    <i class="fas fa-check"></i> Ya, Checkout
                                </button>
                            </div>
                        </div>
                    </div>
